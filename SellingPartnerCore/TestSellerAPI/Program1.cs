...
//  //.awsAuthenticationCredentials(new AWSAuthenticationCredentialsBuilder().SetAccessKeyId("").SetRegion("").SetSecretKey("").Build())
//  //.lwaAuthorizationCredentials(new LWAAuthorizationCredentialsBuilder().SetClientId("").SetRefreshToken("").SetClientSecret("").Build())
//  //.endpoint("https://sellingpartnerapi-na.amazon.com")
//  //.Build();



//            //private static  LWAAuthorizationCredentials lwaAuthorizationCredentials = LWAAuthorizationCredentials.builder()
...
//            //private static  AWSAuthenticationCredentials awsAuthenticationCredentials = AWSAuthenticationCredentials.builder()
...
//        private static void callRestrictedOperationWorkflow()
//        {
//            // Define the path for the restricted operation that requires an RDT.
//            String resourcePath = "/orders/v0/orders/123-1234567-1234567/address";
