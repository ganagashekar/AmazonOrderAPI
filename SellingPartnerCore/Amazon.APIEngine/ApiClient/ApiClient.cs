...
namespace Amazon.APIEngine.ApiClient
{
        ...
        public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = Amazon.APIEngine.ApiClient.Configuration.Default;
        ...
        {
            Configuration = config ?? Amazon.APIEngine.ApiClient.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://sellingpartnerapi-na.amazon.com/")
        {
           if (String.IsNullOrEmpty(basePath))
            ...
            Configuration = APIEngine.ApiClient.Configuration.Default;
        }
            ...
            String contentType)
        {
            var request = PrepareRequest(
                path, method, queryParams, postBody, headerParams, formParams, fileParams,
                pathParams, contentType);
            request = new AWSSigV4Signer(Configuration.AWSAuthenticationCredentials).Sign(request, RestClient.BaseUrl.Host);
            InterceptRequest(request);
