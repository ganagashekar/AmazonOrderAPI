...
namespace AmazonOrderExtentions.CoreExtentions
{
    public static class CoreMapExtension
    {
        ...
        //public static List<TDest> ToDestinationList<List<TSource>,List<TDest>>(this List<TSource> source, List<TDest> dest = null)
        //   where TSource : class, new()
        //   where TDest : class, new()
        //{
        //    if (source.IsNull())
        ...
        /// <param name="opts">Option Data.</param>
        /// <returns></returns>
        //public static TDest ToDestinationPaged<TSource, TDest>(this PagedList<TSource> source, TDest dest, Action<IMappingOperationOptions> opts = null)
        //     where TSource : class, new()
        //     where TDest : class, new()
        //{
        //    if (source.IsNull())
