...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class BuyerTaxInfo : AbstractMwsObject
    {
        ...
        {
            get { return _companyLegalName; }
            set { _companyLegalName = value; }
        }
        ...
        {
            _companyLegalName = companyLegalName;
            return this;
        }
        ...
        {
            get { return _taxingRegion; }
            set { _taxingRegion = value; }
        }
        ...
        {
            return _taxingRegion != null;
        }

        /// <summary>
        /// Gets and sets the TaxClassifications property.
        /// </summary>
        public virtual List<TaxClassification> TaxClassifications
        {
            get
            {
                if (_taxClassifications == null)
                {
                    _taxClassifications = new List<TaxClassification>();
                }
                return _taxClassifications;
            }
            set { _taxClassifications = value; }
        }
        ...
        {
            _taxClassifications.AddRange(taxClassifications);
            return this;
        }
        ...
        {
            return TaxClassifications.Count > 0;
        }
