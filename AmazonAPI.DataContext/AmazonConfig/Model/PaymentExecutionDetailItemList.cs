...
namespace MarketplaceWebServiceOrders.Model
{
    ...
    public class PaymentExecutionDetailItemList : AbstractMwsObject
    {
        ...
        public List<PaymentExecutionDetailItem> PaymentExecutionDetailItem
        {
            get
            {
                if (_paymentExecutionDetailItem == null)
                {
                    _paymentExecutionDetailItem = new List<PaymentExecutionDetailItem>();
                }
                return _paymentExecutionDetailItem;
            }
            set { _paymentExecutionDetailItem = value; }
        }
        ...
        {
            _paymentExecutionDetailItem.AddRange(paymentExecutionDetailItem);
            return this;
        }
