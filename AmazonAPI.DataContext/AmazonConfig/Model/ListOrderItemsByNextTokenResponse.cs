...
namespace MarketplaceWebServiceOrders.Model
{
    public class ListOrderItemsByNextTokenResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            get { return _listOrderItemsByNextTokenResult; }
            set { _listOrderItemsByNextTokenResult = value; }
        }
        ...
        {
            _listOrderItemsByNextTokenResult = listOrderItemsByNextTokenResult;
            return this;
        }
        ...
        {
            return _listOrderItemsByNextTokenResult != null;
        }
        ...
        {
            return $"{{{nameof(ListOrderItemsByNextTokenResult)}={ListOrderItemsByNextTokenResult}, {nameof(ResponseMetadata)}={ResponseMetadata}, {nameof(ResponseHeaderMetadata)}={ResponseHeaderMetadata}}}";
        }
    }
}