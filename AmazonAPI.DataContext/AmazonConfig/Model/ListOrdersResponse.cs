...
namespace MarketplaceWebServiceOrders.Model
{
    public class ListOrdersResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            get { return _listOrdersResult; }
            set { _listOrdersResult = value; }
        }
        ...
        {
            _listOrdersResult = listOrdersResult;
            return this;
        }
        ...
        {
            return $"{{{nameof(ListOrdersResult)}={ListOrdersResult}, {nameof(ResponseMetadata)}={ResponseMetadata}, {nameof(ResponseHeaderMetadata)}={ResponseHeaderMetadata}}}";
        }
    }
}