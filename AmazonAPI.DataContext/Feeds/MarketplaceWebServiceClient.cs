    ...
    */
    public class MarketplaceWebServiceClient : IMarketplaceWebService
    {
           ...
           MarketplaceWebServiceConfig config)
        {
            ...
            connection.AwsAccessKeyId = awsAccessKeyId;
            connection.AwsSecretKeyId = awsSecretAccessKey;
            connection.LibraryVersion = config.ServiceVersion;
            servicePath = config.ServiceURL;
        ...
        public MarketplaceWebServiceClient(String accessKey, String secretKey)
            : this(accessKey, secretKey, new MarketplaceWebServiceConfig())
        {
        }
